...
<функция> -> fn <имя функции>(<аргументы функции>):<тип возвращаемого значения><тело функции>
<имя функции> -> <идентификатор>
<идентификатор> -> <буква> | цифра | _ | <буква><сложный идентификатор>
<сложный идентификатор> -> <буква><сложный идентификатор> | <цифра><сложный идентификатор> | _<сложный идентификатор>
<аргументы функции> -> <аргумент> | <аргумент>, <аргументы функции>
<аргумент> -> <имя переменной>
<имя переменной> -> <идентификатор>
<тип возвращаемого значения> -> none | | bool | double | array | string | pointer
<тело функции> -> <ветвление>|<циклы>|<операции>| <ветвление><тело функции>|<циклы><тело функции>|<операции><тело функции>
...
<объявление переменной или пустота> -> <объявление переменной> |<пустой символ>
<условие или пустота> -> <условие> | <пустой символ>
<операция или пустота> -> <оперкция> | <пустой символ>
<пустой символ> ->  |

<операции> -> <операция> | <операция><операции>
<операция> -> <унарная операция> | <бинарная операция присвоение>
<унарная операция> -> <имя переменной>++ | <имя переменной>-- 
<бинарная операция присвоение> -> <имя переменной> = <бинарная операция>
<бинарная операция> -> <имя переменной> <оператор> <имя переменной> | <бинарная операция> <оператор> <имя переменной> | <имя переменной> <оператор> <бинарная операция>
