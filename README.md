...
//Типы данных
<значение типа данных> ::= none | bool | double | <контейнер> | string
...
<значение> ::= <имя переменной> | <значение типа данных> | <функция с параметрами> | <выражение>
...
<унарная операция> ::= <унарный арифметический оператор><имя переменной> | <имя переменной><унарный арифметический оператор>
